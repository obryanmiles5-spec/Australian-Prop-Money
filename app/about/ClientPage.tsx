    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16 sm:space-y-24 animate-fade-in" id="about-page-container">
      ...
      <div className="space-y-4 text-center max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-gray-500 max-w-2xl mx-auto leading-relaxed">
          Crafting the highest quality, color-calibrated australian prop money for television, film, theatre, and training across Oceania while prioritizing federal compliance. We are your trusted source for prop money australia.
        </p>
      </div>
      ...
      <div className="relative aspect-[16/10] md:aspect-[21/9] min-h-[300px] md:min-h-[400px] bg-zinc-950 rounded-3xl overflow-hidden shadow-xl border border-zinc-800 max-w-5xl mx-auto flex items-end p-6 sm:p-10">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-serif font-bold text-xl sm:text-2xl md:text-3xl text-white max-w-xl mt-1">
            Engineered for high-definition digital lenses and 4K cameras. The best prop money australia has to offer.
          </h2>
        </div>
      </div>
