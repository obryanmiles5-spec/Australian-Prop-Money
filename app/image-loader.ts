  ...
  // 4. Product handling
    ...
    if (lowerRel.includes('australian-notes')) {
      ...
      const VERIFIED_PRODUCTS: Record<string, string> = {
        ...
        'training-currency/classroom-finance-education-play-pack': 'Training Currency/Bank-Teller-Training-Starter-Bundle.png',
        'bundle-packs/the-millionaire-heist-master-crate-(100-stacks)': 'Bundle Packs/Production-Supply-Wholesaler-Mega-Box.png',
